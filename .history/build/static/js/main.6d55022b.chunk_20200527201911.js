(this["webpackJsonpcity-tours"] = this["webpackJsonpcity-tours"] || []).push([
  [0],
  [
    ,
    ,
    ...
    ,
    function (e, t, n) {
      e.exports = n.p + "static/media/logo.12a6659f.svg";
    },
    function (e, t, n) {
      e.exports = n(18);
    },
    ...
    function (e, t, n) {
      ...
      function l() {
        return r.a.createElement(
          "nav",
          { className: "navbar" },
          r.a.createElement("img", { src: s.a, alt: "city tours company" }),
          r.a.createElement(
            "ul",
            { className: "nav-links" },
            r.a.createElement(
          ...
          (function (e) {
            ...
            function n() {
              ...
              return (
                ...
                (e.handleInfo = function () {
                  e.setState({ showInfo: !e.state.showInfo });
                }),
                e
              );
            }
              ...
              Object(u.a)(n, [
                {
                  key: "render",
                  value: function () {
                    var e = this.props.tour,
                      t = e.id,
                      n = e.city,
                      a = e.img,
                      o = e.name,
                      i = e.info,
                      c = this.props.removeTour;
                    return r.a.createElement(
                      "article",
                      { className: "tour" },
                      r.a.createElement(
                      ...
                      r.a.createElement(
                        ...
                        this.state.showInfo && r.a.createElement("p", null, i)
                      )
                    );
                  },
                },
        ...
        g = (function (e) {
          ...
          function n() {
            ...
            for (var a = arguments.length, r = new Array(a), o = 0; o < a; o++)
              r[o] = arguments[o];
            return (
              ((e = t.call.apply(t, [this].concat(r))).state = { tours: h }),
              (e.removeTour = function (t) {
                var n = e.state.tours.filter(function (e) {
                  return e.id !== t;
                });
                e.setState({ tours: n });
              }),
...
//# sourceMappingURL=main.6d55022b.chunk.js.map
